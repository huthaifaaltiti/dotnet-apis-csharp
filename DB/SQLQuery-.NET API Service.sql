...
INSERT INTO Users (ID, Username, NationalNumber, Email, Phone)
VALUES
    (1, 'Huthaifa Altiti', 123456789, 'huthaifa@example.com', '123-456-7890'),
    (2, 'Qusai Albawaizeh', 987654321, 'qusai@example.com', '987-654-3210'),
    (3, 'Bassam Alnabulsi', 456789123, 'bassam@example.com', '456-789-1230'),
    (4, 'Lina Ahmad', 789123456, 'lina@example.com', '789-123-4560'),
    (5, 'Mohammed Hassan', 654321987, 'mohammed@example.com', '654-321-9870');
...
Users.NationalNumber, Users.Email, Users.Phone, 
Users.IsActive FROM Users WHERE Users.NationalNumber = 123456789;